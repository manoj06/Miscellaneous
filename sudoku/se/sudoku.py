...
a7=[]
a8=[]
while a in a0 or a in b1 or a==d or a==g:
	a=random.randint(1,9)
a0.append(a)
b1.append(a)
while b in a0 or b in b3 or b==e or b==h:
	b=random.randint(1,9)
a0.append(b)
b3.append(b)
while c in a0 or c in b8 or c==f or c==i:
	c=random.randint(1,9)
a0.append(c)
b8.append(c)
while d in a1 or d in b0 or d==a or d==g:
	d=random.randint(1,9)
a1.append(d)
b0.append(d)
while e in a1 or e in b4 or e==b or e==h:
	e=random.randint(1,9)
a1.append(e)
b4.append(e)
while f in a1 or f in b6 or f==c or f==i:
	f=random.randint(1,9)
a1.append(f)
b6.append(f)
while g in a2 or g in b2 or g==a or g==d:
	g=random.randint(1,9)
a2.append(g)
b2.append(g)
while h in a2 or h in b5 or h==b or h==e:
	h=random.randint(1,9)
a2.append(h)
b5.append(h)
while i in a2 or i in b7 or i==f or i==c:
	i=random.randint(1,9)
a2.append(i)
b7.append(i)
while j in a3 or j in b0 or j==m or j==p:
	j=random.randint(1,9)
a3.append(j)
b0.append(j)
while k in a3 or k in b3 or k==n or k==q:
	k=random.randint(1,9)
a3.append(k)
b3.append(k)
while l in a3 or l in b6 or l==o or l==r:
	l=random.randint(1,9)
a3.append(l)
b6.append(l)
while m in a4 or m in b1 or m==j or m==p:
	m=random.randint(1,9)
a4.append(m)
b1.append(m)
while n in a4 or n in b5 or n==k or n==q :
	n=random.randint(1,9)
a4.append(n)
b5.append(n)
while o in a4 or o in b8 or o==l or o==r:
	o=random.randint(1,9)
a4.append(o)
b8.append(o)
while p in a5 or p in b2 or p==m or p==j:
	p=random.randint(1,9)
a5.append(p)
b2.append(p)
while q in a5 or q in b4 or q==k or q==n:
	q=random.randint(1,9)
a5.append(q)
b4.append(q)
while r in a5 or r in b6 or r==l or r==o:
	r=random.randint(1,9)
a5.append(r)
b6.append(r)
while s in a6 or s in b0 or s==v or s==x:
	s=random.randint(1,9)
a6.append(s)
b0.append(s)
while t in a6 or t in b3 or t==w or t==y:
	t=random.randint(1,9)
a6.append(t)
b3.append(t)
while u in a6 or u in b7 or u==k1 or u==z:
	u=random.randint(1,9)
a6.append(u)
b7.append(u)
while v in a7 or v in b1 or v==s or v==x:
	v=random.randint(1,9)
a7.append(v)
b1.append(v)
while w in a7 or w in b5 or w== t or w==y:
	w=random.randint(1,9)
a7.append(w)
b5.append(w)
while k1 in a7 or k1 in b7 or k1==u or k1==z:
	k1=random.randint(1,9)
a7.append(k1)
b7.append(k1)
while x in a8 or x in b2 or x==s or x==v:
	x=random.randint(1,9)
a8.append(x)
b2.append(x)
while y in a8 or y in b4 or y==w or y==t:
	y=random.randint(1,9)
a8.append(y)
b4.append(y)
while z in a8 or z in b8 or z==k1 or z==u:
	z=random.randint(1,9)
a8.append(z)
b8.append(z)
fnt=("Arial",16,"bold")
